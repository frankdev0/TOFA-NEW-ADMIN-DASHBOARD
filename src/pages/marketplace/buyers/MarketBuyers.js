...
import { marketBaseUrl } from "../../components/marketBaseUrl";
...
const MarketBuyers = () => {
  ...
  const getData = async () => {
    try {
      marketBaseUrl.get("/auth/users").then((response) => {
  ...
  const handleDelete = (faqID) => {
    marketBaseUrl.delete(`/faq/${faqID}`).then(() => {
      getData();
    });
  };
  ...
  const showDetails = (faqID) => {
    setViewLoader(true);
    marketBaseUrl.get(`/faq/${faqID}`).then((response) => {
                                          ...
                                          <div className="modal-content">
                                            ...
                                            <div className="d-flex ">
                                              <div className="modal-body">
                                                Question: {viewBuyer.question}
                                              </div>
                                              <div className="modal-body">
                                                Answer: {viewBuyer.answer}
                                              </div>
                                            </div>
