              ...
              <ul className="navbar-nav flex-column">
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-2" className="collapse submenu">
                    <ul className="nav flex-column">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="general.html">
                          General
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="listgroup.html">
                          List Group
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="accordions.html">
                          Accordions
                        </a>
                      </li>
                      <li className="nav-item">
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-3" className="collapse submenu">
                    <ul className="nav flex-column">
                      <li className="nav-item">
                        <a className="nav-link" href="chart-c3.html">
                          C3 Charts
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="chart-chartist.html">
                          Chartist Charts
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="chart-charts.html">
                          Chart
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="chart-gauge.html">
                          Guage
                        </a>
                      </li>
                    </ul>
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-6" className="collapse submenu">
                    <ul className="nav flex-column">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="blank-page.html">
                          Blank Page
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="blank-page-header.html">
                          Blank Page Header
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="404-page.html">
                          404 page
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a
                          className="nav-link"
                          href="sortable-nestable-lists.html"
                        >
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="cropper-image.html">
                          Cropper
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="color-picker.html">
                          Color Picker
                        </a>
                      </li>
                    </ul>
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-7" className="collapse submenu">
                    <ul className="nav flex-column">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="email-details.html">
                          Email Detail
                        </a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="message-chat.html">
                          Message Chat
                        </a>
                      </li>
                    </ul>
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-8" className="collapse submenu">
                    <ul className="nav flex-column">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="icon-weather.html">
                          Weather Icon
                        </a>
                      </li>
                    </ul>
                ...
                <li className="nav-item">
                  ...
                  <div id="submenu-9" className="collapse submenu">
                    <ul className="nav flex-column">
                      <li className="nav-item">
                        <a className="nav-link" href="map-google.html">
                          Google Maps
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="map-vector.html">
                          Vector Maps
                        </a>
                      </li>
                    </ul>
